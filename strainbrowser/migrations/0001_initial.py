# Generated by Django 4.0.6 on 2022-11-13 13:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'permissions': [('strainbrowser.operator', 'Strainbrowser operator'), ('strains.breeder.add', 'Allowed to add breeders'), ('strains.breeder.edit', 'Allowed to edit all breeders'), ('strains.breeder.delete', 'Allowed to delete breeders')],
            },
        ),
        migrations.CreateModel(
            name='Strain',
            fields=[
                ...
                ('added_on', models.DateTimeField(auto_now_add=True)),
                ('edited_on', models.DateTimeField(auto_now=True)),
                ('added_by', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='strain_added_by', to=settings.AUTH_USER_MODEL)),
                ('breeder', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.RESTRICT, to='strainbrowser.breeder')),
                ('edited_by', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='strain_edited_by', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_on', models.DateTimeField(auto_now_add=True)),
                ('edited_on', models.DateTimeField(auto_now=True)),
                ('added_by', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='strain_translation_added_by', to=settings.AUTH_USER_MODEL)),
                ('edited_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='strain_translation_edited_by', to=settings.AUTH_USER_MODEL)),
